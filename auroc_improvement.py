...
#with additional data in the chemical space of interest
...
def auroc_improvement(auroc_original, auroc_improv, std_dev_original, std_dev_improv, folds):
    ...
    proportion_increase = delta / performance_available 	#proportion of auroc score gained, out of the score still possible to achieve
    ...
    #relative error in auroc improvement
